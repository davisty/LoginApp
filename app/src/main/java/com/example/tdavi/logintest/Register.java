...
public class Register extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final EditText uAge = (EditText) findViewById(R.id.uAge);
        ...
        final Button uRegister = (Button) findViewById(R.id.uRegister);
        ...
        uRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final int age = Integer.parseInt(uAge.getText().toString());
